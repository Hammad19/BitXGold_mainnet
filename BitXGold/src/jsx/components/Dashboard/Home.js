...
const Home = () => {
  ...
  const [bxgstacked, setbxgstacked] = useState(0.0);
  const [referralBonus, setreferralBonus] = useState(0);
  const [stakingreferralBonus, setStakingReferralBonus] = useState(0);
  ...
  const FetchData = async () => {
    ...
    try {
      ...
      const { data } = await axiosInstance.get(
        "/api/bxg/" + requestBody.wallet_address
      );
      const data1 = await axiosInstance.get(
        "/api/stake/" + requestBody.wallet_address
      );
      const data3 = await axiosInstance.get(
        "/api/bonusrefer/" + requestBody.wallet_address
      );
      const data4 = await axiosInstance.get("/api/stakerefreward/getall");
      const data5 = await axiosInstance.get("/api/bonusrefreward/getall");
      const data6 = await axiosInstance.get(
        "/api/stakerefreward/" + requestBody.wallet_address
      );
      const data7 = await axiosInstance.get(
        "/api/bonusrefreward/" + requestBody.wallet_address
      );
      setbxgavailable(data.bxg);
      setbxgstacked(data1.data.bxg);
      settotalEarning(data1.data.total_claim_reward);
      var referalbonus = 0;
      ...
      data6.data
        .filter(
          (item) =>
            item.refer_code?.toLowerCase() === state.auth.auth.walletaddress
        )
        .map((item) => {
      ...
      setreferralBonus(referalbonus);
      setStakingReferralBonus(stakingreferbonus);
              ...
              <div className="row">
                ...
                <div className="col-xl-12">
                  <Swiper
                    ...
                    <SwiperSlide>
                      <div
                        className="card card-wiget"
                        style={{ height: "150px" }}>
                        <div className="card-body">
                          <div className="card-wiget-info">
                            <h4 className="count-num">
                              {bxgavailable ? bxgavailable : 0.0} BXG
                            </h4>
                            <p>{t("dashboard_card_1")}</p>
                            <div>
                    ...
                    <SwiperSlide>
                      <div
                        ...
                        <div className="card-body">
                          <div className="card-wiget-info">
                            <h4 className="count-num">
                              {bxgstacked ? bxgstacked : 0.0} BXG
                            </h4>
                            <p>{t("dashboard_card_2")}</p>
                            {/* <div>
                      ...
                      <div
                        ...
                        <div className="card-body">
                          <div className="card-wiget-info">
                            <h4 className="count-num">
                              {referralBonus
                                ? Math.round(referralBonus * 100) / 100
                                : 0.0}{" "}
                              USDT
                            </h4>
                            <p className="sm-chart">{t("dashboard_card_3")}</p>
                          </div>
                        </div>
                        <div className="back-icon">
                          <svg
                          ...
                          <div className="card-wiget-info">
                            <h4 className="count-num">
                              {stakingreferralBonus
                                ? Math.round(stakingreferralBonus * 100) / 100
                                : 0.0}{" "}
                              BXG
                            </h4>
                            <p className="sm-chart">{t("dashboard_card_4")}</p>
                          </div>
                        </div>
                        <div className="back-icon">
                          <svg
                      ...
                      <div
                        ...
                        <div className="card-body">
                          <div className="card-wiget-info rewards">
                            <h4 className="count-num">
                              {totalEarning ? totalEarning : 0.0} BXG{" "}
                            </h4>
                            <p>{t("dashboard_card_5")}</p>
                          </div>
                        </div>
                        <div className="back-icon">
                          <svg
